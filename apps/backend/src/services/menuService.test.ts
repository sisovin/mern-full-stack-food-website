import { getAllMenuItems, getMenuItemById, createMenuItem, updateMenuItem, deleteMenuItem } from './menuService';
...
describe('Menu Service', () => {
  describe('getAllMenuItems', () => {
    it('should return all menu items', async () => {
      const mockMenuItems = [
        { _id: '1', name: 'Item 1', description: 'Description 1', price: 10, category: 'Category 1' },
        { _id: '2', name: 'Item 2', description: 'Description 2', price: 20, category: 'Category 2' },
      ];
  ...
  describe('getMenuItemById', () => {
    it('should return a menu item by id', async () => {
      const mockMenuItem = { _id: '1', name: 'Item 1', description: 'Description 1', price: 10, category: 'Category 1' };
  ...
  describe('createMenuItem', () => {
    it('should create a new menu item', async () => {
      const mockMenuItemData = { name: 'New Item', description: 'New Description', price: 15, category: 'New Category' };
  ...
  describe('updateMenuItem', () => {
    it('should update a menu item', async () => {
      const mockMenuItemData = { name: 'Updated Item', description: 'Updated Description', price: 20, category: 'Updated Category' };
      const mockMenuItem = { _id: '1', ...mockMenuItemData };
      (Menu.findByIdAndUpdate as jest.Mock).mockResolvedValue(mockMenuItem);

      const result = await updateMenuItem('1', mockMenuItemData);

      expect(Menu.findByIdAndUpdate).toHaveBeenCalledWith('1', mockMenuItemData, { new: true });
      expect(result).toEqual(mockMenuItem);
    });
    ...
    it('should throw an error if menu item not found', async () => {
      ...
      await expect(updateMenuItem('1', {})).rejects.toThrow('Menu item not found');
    });
  });
